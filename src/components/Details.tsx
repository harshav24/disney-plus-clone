...
import {BsFillPlayFill, BsPeople, BsPeopleFill, BsPlus} from "react-icons/bs";
...
export const Details = () => {
  ...
  return (
    <Container>
      ...
      <Controls>
          <PlayButton>
              <BsFillPlayFill color='black' size={25}/>
              <span>PLAY</span>
          </PlayButton>
          <TrailerBUtton>
              <BsFillPlayFill color='white' size={25} />
              <span>TRAILER</span>
          </TrailerBUtton>
          <AddButton>
              <BsPlus  color="black" size={25} />
          </AddButton>
          <GroupWatch>
              <BsPeopleFill />
          </GroupWatch>
...
// want a json file for movies images and names for 20+ movies in disney plus hotstar?
